...
\begin{center}
	...
	\bigskip
	\footnotesize Autonomous Systems Lab \\
...
% ---------- Comments ---------- %
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	\multicolumn{1}{@{}l@{}}{\headbf{Comments}} \\
	\mytoprule
	\code{\ctrlp \altp T} is a desktop environment shortcut actually. However, it fits in the Linux Shell section for now. \hlx
	some concise explanation of the whole TF concept \\
	\mybottomrule
\end{tabularx}
\spacebtwtables
