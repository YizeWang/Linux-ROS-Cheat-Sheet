...
\newcolumntype{T}{>{\columncolor{white}[\tabcolsep][0pt]}m{28em}}
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\cmd{rostopic type\vb{TOPIC}}		& print type of \vb{TOPIC} \\
	\mybottomrule
\end{tabularx}
\spacebtwtables
...
\begin{tabularx}{\linewidth}[ht]{@{}LS@{}}
	...
	\cmd{rosservice uri \vb{SERVICE}}				& print uri of \vb{SERVICE} \\
	\mybottomrule
\end{tabularx}
\spacebtwtables
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\mybottomrule
\end{tabularx}
remember to source \textasciitilde/catkin\_ws/devel/setup.bash
\spacebtwtables

% ---------- ROS Packge Structure ---------- %
\begin{tabularx}{\linewidth}[ht]{@{}LT@{}}
	\multicolumn{2}{@{}l@{}}{\headbf{ROS Packge Structure}} \\
	\mytoprule
	\cmd{package.xml}		& manifest, dependencies and plugins \hlx
	\cmd{CMakeLists.txt}	& description of compilation procedure \hlx
	\cmd{src/}				& C and C++ source codes \hlx
	\cmd{include/}			& C and C++ header files \hlx
	\cmd{scripts/}			& Python and bash scripts \hlx
	\cmd{config/}			& ymal configuration files \hlx
	\cmd{cfg/}				& dynamics reconfigure scripts \hlx
	\cmd{launch/}			& launch files \\
	\mybottomrule
\end{tabularx}
\spacebtwtables
