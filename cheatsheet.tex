...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\mytoprule
	\cmd{ls}						& list contents of current directory \hlx
	...
	\cmd{more \vb{FILE}}			& print content of \vb{FILE} \hlx
...
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	{ \begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
		...
		\cmd{ps}					& print currently running processes \hlx
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\mybottomrule
\end{tabularx}
Always remember to \cb{source ~/catkin\_ws/devel/setup.bash}.
\spacebtwtables
...
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	...
	Eigen \hlx
	ROS programming \\
	remove Compression sections if needed \\
	remove Network sections if needed \\
	grep \\
