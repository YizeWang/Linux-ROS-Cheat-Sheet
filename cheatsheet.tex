...
\newcommand{\codebox}[1]{\tikz[baseline]{\node[rectangle, rounded corners=0.5mm, text=black, fill=black!20, inner sep=1pt, anchor=base]{#1}}}
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\cmd{cd \codebox{\$DIR}}				& change working directory to \codebox{\$DIR} \hlx
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\cmd{\ctrlp \shiftp O}		& split window horizontally \\
	\mybottomrule
\end{tabularx}
\spacebtwtables
