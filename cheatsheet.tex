...
\begin{tabularx}{\linewidth}[ht]{@{}LS@{}}
	...
	Eg. \$ rosrun tf tf\_echo /map /odom						& \vb{FRAME1} and \vb{FRAME2} \hlx
...
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	...
	\end{tabularx} } \\
	{ \begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
			\xmltag{include file=\vb{LAUNCH\_FILE}}			& import \vb{LAUNCH\_FILE} into the current one \\
	\end{tabularx} } \\
	{ \begin{tabularx}{\linewidth}[ht]{@{}L@{}}
...
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	...
	\mytoprule
	\code{\ctrlp \altp T} is a desktop environment shortcut actually, not Linux Shell command. \hlx
	launch file section is only useful, if the (at least most commonly used) arguments are explained as well. \hlx
	ROS variables. \\
	\mybottomrule
\end{tabularx}
\bigskip
