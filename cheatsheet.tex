...
\begin{tabularx}{\linewidth}[ht]{@{}LS@{}}
	...
	\mytoprule
	\cmd{rosrun tf tf\_echo \vb{FRAME1} \vb{FRAME2}}		& print frame relationship between \\
	\$ rosrun tf tf\_echo /map /odom						& \vb{FRAME1} and \vb{FRAME2} \hlx
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	elevation\_mapping				& produce elevation map around robot \\
	traversability\_estimation		& traversability mapping for rough terrain \\
	icp\_mapper						& iterative closest point based slam system \\
	smb\_local\_planner				& path planning system for SMB \hlx
	\code{Configuration}			& \\
	Placeholder						& \\
	Placeholder						& \\
	Placeholder						& \\
...
% ---------- Thomas Comments ---------- %
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	\multicolumn{1}{@{}l@{}}{\headbf{Thomas Comments}} \\
	\mytoprule
	\code{\ctrlp \altp T} is a desktop environment shortcut actually. However, it fits in the Linux Shell section for now. \hlx
	launch file section i only useful, if the (at least most commonly used) arguments are explained as well. \hlx
	ROS variables. \\
	\mybottomrule
\end{tabularx}
\bigskip
