...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\cmd{ls -a}						& list hidden contents of current directory \hlx
	\cmd{cd \vb{DIR}}				& change working directory to \vb{DIR} \\
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\cmd{catkin config \vb{arg1}}					& \hlx
	\cmd{wstool init}								& \\
	\cmd{wstool merge \vb{arg1}}					& \\
	\cmd{wstool up}									& \\
	\mybottomrule
\end{tabularx}
Always remember to \cb{\cmd{source ~/catkin\_ws/devel/setup.bash}}.
\spacebtwtables
...
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	...
	\code{ROS\_PACKAGE\_PATH}	& locations for more ROS packages \hlx
...
% ---------- ROS Launch File ---------- %
\begin{tabularx}{\linewidth}[ht]{@{}LR@{}}
	\multicolumn{2}{@{}l@{}}{\headbf{ROS Launch File}} \\
	\mytoprule
	& \\
	& \\
	& \\
...
\begin{tabularx}{\linewidth}[ht]{@{}L@{}}
	...
	rosnode machine \hlx
	CMakeList \hlx
	what should I annotate on \cmd{catkin clean}? \\
